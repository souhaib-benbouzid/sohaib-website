  ...
  aboutMe: {
    ...
    experience: {
      ...
      first: {
        ...
        description2:
          "Rework and improve the website’s frontend application using React & Redux written in Typescript. As well as, localize it into different languages and Implement unite, integration, and acceptance tests using Jest Framework.",
        description3:
